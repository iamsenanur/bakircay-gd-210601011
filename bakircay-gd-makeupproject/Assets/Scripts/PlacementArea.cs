...
public class PlacementArea : MonoBehaviour
{
    ...
    private bool isWindSkillActive = false; // Wind Skill durumu
    ...
    public void SetWindSkillState(bool state)
    {
        isWindSkillActive = state;
        Debug.Log($"Wind Skill durumu deðiþti: {state}");
    }


    void OnTriggerEnter(Collider other)
    {
        if (!other.CompareTag("Draggable") || isProcessingMatch || isWindSkillActive) return;
    ...
    private string GetCubeColor(GameObject obj)
    {
        ...
        if (objName.Contains("capsule"))
        {
            ...
            if (objName.Contains("green")) return "GreenCapsule";
        }
        ...
        if (objName.Contains("sphere") || objName.Contains("circle"))
        {
            ...
            if (objName.Contains("yellow")) return "YellowSphere";
        }
