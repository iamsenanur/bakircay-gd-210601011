...
public class WindSkill : MonoBehaviour
{
    ...
    private IEnumerator VortexEffect()
    {
        ...
        // PlacementArea'da eþleþmeleri durdur
        if (placementArea != null)
        {
            placementArea.SetWindSkillState(true);
        }
        ...
        // PlacementArea'da eþleþmeleri yeniden baþlat
        if (placementArea != null)
        {
            placementArea.SetWindSkillState(false);
        }
